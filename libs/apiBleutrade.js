...
module.exports = function() {
    ...
    // Constants
    var version         = '0.1.0',
        PUBLIC_API_URL  = 'https://bleutrade.com/api/v2/public',
        PRIVATE_API_URL = 'https://bleutrade.com/api/v2/market',
        USER_AGENT      = 'nomp/node-open-mining-portal'

    // Constructor
    function Bleutrade(key, secret){
        ...
        this._getPrivateHeaders = function(parameters){
            ...
            if (!key || !secret){
                throw 'Bleutrade: Error. API key and secret required';
            }
    ...
    Bleutrade.prototype = {
        ...
        _request: function(options, callback){
            ...
            options.json = true;
            options.strictSSL = Bleutrade.STRICT_SSL;
